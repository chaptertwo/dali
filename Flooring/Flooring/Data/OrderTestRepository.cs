...
namespace Flooring.Data
{
    ...
    {        
        ...
        public List<Order> FindByOrderDate(DateTime day)
        {
            ...
            string directoryStart = @"C:\Data\Flooring\TestOrders\";
        ...
        {
            var orders = FindByOrderDate(day);
            //need to add a precaution for if null
            if(orders == null)
            {
                return 1;
            }
        ...
        public void Remove(List<Order> orders, Order orderToRemove, DateTime day) 
        {
